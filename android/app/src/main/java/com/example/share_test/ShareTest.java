...
// /** ShareTest */
// public class ShareTest implements FlutterPlugin, MethodCallHandler {
...
//         final ShareTest instance = new ShareTest();
...
//         methodChannel = new MethodChannel(messenger, "share_test");
